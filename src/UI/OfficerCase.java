	...
	private void initialize() throws ClassNotFoundException, SQLException {
		...
		lblLogOut.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				JOptionPane.showMessageDialog(frmOfficerCase, "Succesfully Logged out.");
		...
		tabbedPane.addTab("New Case", null, desktopPane, null);
		...
		Image im = new ImageIcon(Objects.requireNonNull(this.getClass().getResource("/resources/case.png"))).getImage();
		lblNewLabel.setIcon(new ImageIcon(im));

        assert frmOfficerCase != null;
