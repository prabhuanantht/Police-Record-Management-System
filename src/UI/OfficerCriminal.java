	...
	private void initialize() throws ClassNotFoundException, SQLException {
		...
		lblLogOut.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				JOptionPane.showMessageDialog(frmCriminals, "Succesfully Logged out.");
				frmCriminals.setVisible(false);
			}
		});
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String status = Objects.requireNonNull(mstatus.getSelectedItem()).toString();
				String Gender = Objects.requireNonNull(gender.getSelectedItem()).toString();
		...
		JButton lblAddImage = new JButton("Add image");
